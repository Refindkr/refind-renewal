...
const DEFAULT_BANNER_COLOR = "#E1251B";
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden">
          ...
          {form.isExhibitionBanner && (
            <div className="px-4 pb-4 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">배너 강조 색상</label>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  메인 히어로에서 이 배너가 다른 슬라이드와 시각적으로 구분되도록 은은한 색 배경이 함께 표시됩니다.
                </p>
              </div>
            </div>
          )}
