      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b-2 border-gray-900">
            ...
            {models.map((m, i) => (
              <th key={m} className={`text-center px-5 py-3.5 text-xs font-bold whitespace-nowrap ${i === 0 ? "text-[#E1251B]" : "text-gray-500"}`}>
                {m}
              </th>
            ))}
          </tr>
        ...
        <tbody className="divide-y divide-gray-50">
          {rows.map((row, i) => (
            <tr key={row.label} className={i % 2 === 0 ? "" : "bg-gray-50/40"}>
              ...
              {row.values.map((v, j) => (
                <td key={j} className={`px-5 py-3 text-center whitespace-nowrap ${j === 0 ? "text-gray-900 font-semibold bg-[#E1251B]/5" : "text-gray-700"}`}>
                  {v}
                </td>
              ))}
            </tr>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-sm text-gray-400 mt-6">
            ...
            {", "}
            <Link href={`/products/humanoid/robot-arm/rx75`} className="text-[#E1251B] font-semibold hover:underline">RX75</Link>
            {isKo ? ", " : ", and "}
