        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="relative h-[420px] md:h-[560px] order-2 md:order-1">
              <Image
                src="/products/humanoid/embodied dual arm.png"
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-white border-b border-gray-100">
                  ...
                  <th className="text-center px-5 py-3.5 text-xs font-bold text-[#E1251B] whitespace-nowrap">Dual Arm Vertical Lift</th>
                  <th className="text-center px-5 py-3.5 text-xs font-bold text-gray-500 whitespace-nowrap">
                    <Link href={`/${locale}/products/humanoid/lifting-platform`} className="hover:text-[#E1251B] transition-colors">Single Arm Vertical Lift</Link>
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                <tr className="bg-white">
                  ...
                  <td className="px-5 py-3.5 text-center text-gray-900 font-semibold bg-[#E1251B]/5">{isKo ? "양팔" : "Dual Arm"}</td>
                ...
                <tr className="bg-gray-50/50">
                  ...
                  <td className="px-5 py-3.5 text-center text-gray-900 font-semibold bg-[#E1251B]/5">{isKo ? "가능" : "Possible"}</td>
                ...
                <tr className="bg-white">
                  ...
                  <td className="px-5 py-3.5 text-center text-gray-900 font-semibold bg-[#E1251B]/5">{isKo ? "제조, 물류, 조립" : "Manufacturing, logistics, assembly"}</td>
